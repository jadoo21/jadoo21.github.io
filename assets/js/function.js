...
function checkUserFullName(){
    var userSurname = document.getElementById("name_id").value;
    var flag = false;
    if(userSurname === ""){
        flag = true;
    }
...
function checkUserPassword(){
    var userPassword = document.getElementById("pass_id");
    ...
    if(flag){
        alert("Password is not matching required condition")
    }
}
...
function signUp(){
    var userFullName = document.getElementById("name_id").value;
...
function checkUserSIEmail(){
    var userSIEmail = document.getElementById("email_id");
...
function checkUserSIPassword(){
    var userSIPassword = document.getElementById("password_id");
...
function signIn(){
    var userSIEmail = document.getElementById("email_id").value;
    var userSIPassword = document.getElementById("password_id").value;
    var userSIEmailFormate = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
    var userSIPasswordFormate = /(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{10,}/;      
